"""
Unified Model Architecture for Glucose Prediction.
Supports various Transformer models including SAINT, FT-Transformer, TabPFN, 
PatchTST, TST, Informer, and TabNet.
...
- TabPFN: Prior-Fitting Transformer for Tabular Data
- PatchTST: Patching-based Time Series Transformer
- TST: Time Series Transformer
- Informer: Efficient Transformer with ProbSparse Attention
- TabNet: Attentive Interpretable Tabular Learning

Traditional ML Models (requires sklearn, xgboost, lightgbm, catboost):
- RandomForest
- XGBoost
- LightGBM
- CatBoost
...
model = ModelFactory.create_model(
    model_name='saint',  # or 'ft-transformer', 'tabpfn', etc.
    categories=[10, 20, 5],  # categorical feature dimensions
    num_continuous=15,  # number of continuous features
